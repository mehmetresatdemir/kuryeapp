...
if pm2 list | grep -q "kurye-backend.*online"; then
    ...
    echo -e "${BLUE}🔗 Health check: http://16.171.131.126:4000:$PORT/health${NC}"
    echo -e "${BLUE}👨‍💼 Admin panel: http://16.171.131.126:4000:$PORT/admin${NC}"
    echo -e "${BLUE}📷 Image upload: http://16.171.131.126:4000:$PORT/api/uploadImage${NC}"
    echo ""
