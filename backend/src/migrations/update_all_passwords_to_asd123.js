...
async function updateAllPasswordsToAsd123() {
  try {
    console.log("🔄 Tüm kullanıcı şifreleri 'asd123' olarak güncelleniyor...");
    ...
    console.log("🎉 Tüm kullanıcıların şifreleri başarıyla 'asd123' olarak güncellendi!");
    console.log("📝 Yeni giriş bilgileri:");
    console.log("   Şifre: asd123");
...
module.exports = updateAllPasswordsToAsd123; 