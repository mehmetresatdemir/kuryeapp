...
with_node \
  ...
  --target "/Users/red/Desktop/kuryeapp2/ios/Pods/Target Support Files/Pods-KuryeX/ExpoModulesProvider.swift" \
  --entitlement "/Users/red/Desktop/kuryeapp2/ios/KuryeX/KuryeX.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-audio" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-device" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-location" "expo-notifications" "expo-router" "expo-secure-store" "expo-splash-screen"
